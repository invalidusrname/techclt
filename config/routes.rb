Techclt::Application.routes.draw do
  ...
  #match ':controller(/:action(/:id(.:format)))' => 'root(/:id)'
  #match ':user/:id' => 'user#edit'
  match '/:id' => 'user#show', :constraints => { :id => /\d.+/ } #SEO the User Ids
  #match '/:full_name' => 'user#show'
